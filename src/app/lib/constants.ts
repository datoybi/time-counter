...
export const DATA = [
  {
    ...
    workingTime:
      dayjs()
        ...
        .minute(0)
        .second(0)
        .diff(dayjs().day(1).hour(9).minute(0).second(0), "minute") - 60,
    dayOff: "none",
  },
  {
    week: "화",
    ...
    workingTime:
      dayjs()
        ...
        .minute(0)
        .second(0)
        .diff(dayjs().day(2).hour(9).minute(0).second(0), "minute") - 60,
    dayOff: "none",
  },
  {
    week: "수",
    ...
    workingTime:
      dayjs()
        ...
        .minute(0)
        .second(0)
        .diff(dayjs().day(3).hour(9).minute(0).second(0), "minute") - 60,
    dayOff: "none",
  },
  {
    week: "목",
    ...
    workingTime:
      dayjs()
        ...
        .minute(0)
        .second(0)
        .diff(dayjs().day(4).hour(9).minute(0).second(0), "minute") - 60,
    dayOff: "none",
  },
  {
    week: "금",
    ...
    workingTime:
      dayjs()
        ...
        .minute(0)
        .second(0)
        .diff(dayjs().day(5).hour(9).minute(0).second(0), "minute") - 60,
    dayOff: "none",
  },
];
